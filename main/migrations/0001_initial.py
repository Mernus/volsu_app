# Generated by Django 3.1.4 on 2021-04-29 18:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=80, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='Имя пользователя')),
                ('fullname', django_cryptography.fields.encrypt(models.CharField(blank=True, max_length=30, null=True, unique=True, validators=[main.validators.FullnameValidator()], verbose_name='ФИО пользователя'))),
                ('organization', django_cryptography.fields.encrypt(models.CharField(blank=True, max_length=120, null=True, validators=[main.validators.TitleValidator()], verbose_name='Организация'))),
                ...
                ('email', django_cryptography.fields.encrypt(models.EmailField(max_length=254, unique=True, verbose_name='Почта пользователя'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', django.contrib.postgres.fields.citext.CICharField(max_length=50, unique=True, validators=[main.validators.TitleValidator()], verbose_name='Тег')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', django_cryptography.fields.encrypt(models.TextField(blank=True, max_length=450, null=True, verbose_name='Описание события'))),
